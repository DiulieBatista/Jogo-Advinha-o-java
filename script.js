const apiKey = '494194aead14fd0f682cf87f7cdd277e' // Substitua pela sua chave de API
let correctMedia;
let options = [];
...
function displayQuestion() {
    ...
    function checkAnswer(selected) {
        ...
        resultDiv.innerHTML = '<p class="cor">Correto!</p>';
        } else {
        resultDiv.innerHTML = `<p class="cor">Incorreto! O filme ou série era: ${correctMedia.title || correctMedia.name}</p>`;
        }
